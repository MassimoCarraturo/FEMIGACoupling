...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [dGXi,dGEta] = computeBaseVectorsAndDerivativesForBSplineSurface(xiSpan,p,etaSpan,q,CP,mixedDerivOrder,dR)
...
%                          dGxi^n/deta^n]
%            dG2 : The array containing the base vector G2 and its 
%                  derivatives sorted as:
