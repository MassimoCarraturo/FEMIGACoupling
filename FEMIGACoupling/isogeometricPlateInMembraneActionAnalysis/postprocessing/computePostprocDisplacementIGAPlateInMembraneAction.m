...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function d = computePostprocDisplacementIGAPlateInMembraneAction(p,q,R,dHatActual)
%% Function documentation
%
% Returns the displacement field d = [dx dy]' at the given parametric
...
%
%     Outout :
%          d : the displacement field d = [dx dy]' at the given parametric
%              location
%
% Function layout :
%
