...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function plot_referenceConfigurationIGAPlateInMembraneAction(p,q,Xi,Eta,CP,isNURBS,rb,Fl,outMsg)
%% Function
%
...
[Xp,Yp,Zp] = createBSplineSurfaceOnCartesianSpace(p,q,Xi,Eta,CP,isNURBS,xiGrid,etaGrid);

% Create the coordinates of the vertices of the support triangles
[xs,ys,zs] = createSupports2D(CP,rb);
