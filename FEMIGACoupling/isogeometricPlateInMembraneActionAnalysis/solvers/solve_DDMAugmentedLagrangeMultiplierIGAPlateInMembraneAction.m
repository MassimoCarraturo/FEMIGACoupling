...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [dHat1,dHat2,lambdaHat,F1,F2,rankDeficiency,condK] = solve_DDMAugmentedLagrangeMultiplierIGAPlateInMembraneAction(patch1,patch2,lagrangeMultiplierField,alpha,intC,outMsg)
%% Function documentation
%
% Returns the displacement and the Lagange Mutlipliers fields as well as 
% the complete force vectors corresponding to the augmented Lagrange 
% Multiplier decomposition method for its application to the isogeometric 
% plate in membrane action analysis decomposed into two subdomains.
%
%                  Input :
...
%
% 6. Assemble to the global stiffness matrix
%
% 7. Compute the generalized load vector
%
% 8. Reduce the system according to the given constraints
%
...
%
% 12. Compute the complete force vectors
% 
% 13. Appendix
%
%% Function main body
if strcmp(outMsg,'outputEnabled')
    ...
    fprintf('isogeometric plate in plane stress action using the augmented \n');
    fprintf('Lagrange Multiplier method has been initiated \n\n');
...
% Form the null matrix
nullMatrix33 = zeros(sm12,sm12);

% Global system matrix for the coupled system
K = [K1 + KPenalty1     CPenalty1           C1
     CPenalty1'         K2 + KPenalty2      C2
     C1'                C2'                 nullMatrix33];
