...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [X,Y,Z] = createBSplineCurveOnCartesianSpace(p,Xi,CP,nEval)
...
for j=1:nEval
    ...
    %% 1ii. Compute the basis functions at xi
    nDeriv = 0;
    R = computeNURBSBasisFunctionsAndDerivativesForCurve(spandIndex,p,xi,Xi,CP,nDeriv);
    
    %% 1iii. Compute the Cartesian coordinates of xi 
    XYZ(j,1:3) = computeCartesianCoordinatesOfAPointOnBSplineCurve(p,spandIndex,xi,Xi,CP,R);
