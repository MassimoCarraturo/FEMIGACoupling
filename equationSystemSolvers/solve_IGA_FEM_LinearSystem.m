...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [u,noNewtonIter,hasConverged,FComplete,minElSize,K] = solve_IGA_FEM_LinearSystem...
    (Beta,uSaved, ...
    uDotSaved,uDDotSaved,XiB,BSplinePatch,F,bodyForces,parameters,u,uDot, ...
    computeLinearMatrices,modifyLinearSystem,DOFNumbering,freeDOFs,homDOFs,inhomDOFs, ...
    valuesInhomDOFs,transientAnalysis,t,nLinearAnalysis,int,outMsg,...
    uSavedFEM, ...
    uDotSavedFEM,uDDotSavedFEM,strMsh,analysisFEM,IBC,FFEM,bodyForcesFEM,...
    parametersFEM,uFEM,uDotFEM, ...
    DOFNumberingFEM,homDOFsFEM,inhomDOFsFEM, ...
    valuesInhomDOFsFEM,strDynamics,nLinearAnalysisFEM)
...
%                       XiB: fixed knot on the interface boundary
...
[KFEM,KIGA,RHS,minElSize] = computeLinearMatrices...
    (u,uSaved,uDot,uDotSaved,...
    DOFNumbering,BSplinePatch,F,transientAnalysis,t,parameters,...
    bodyForces,int,...
    uFEM,uSavedFEM,uDotFEM,uDotSavedFEM,...
    DOFNumberingFEM,strMsh,analysisFEM,FFEM,...
    strDynamics,parametersFEM);

K = modifyLinearSystem...
    (KFEM,KIGA,IBC,u,uSaved,uDot,uDotSaved,...
    DOFNumbering,XiB,BSplinePatch,transientAnalysis,t,parameters,...
    int,...
    uFEM,uSavedFEM,uDotFEM,uDotSavedFEM,...
    DOFNumberingFEM,strMsh,analysisFEM,...
    strDynamics,parametersFEM,Beta,bodyForces);
