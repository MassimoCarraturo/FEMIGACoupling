...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [dHat1,dHat2,F1,F2,minEig,rankDefinciency,condK] = solve_DDMNitscheElementwiseStabilIGAPlateInMembraneAction(patch1,patch2,gamma,intC,outMsg)
...
% membrane action problem. The stabilization parameter is estimated 
% element-wise and not globally as in the initial publication :
%
...
%
% 3. Compute the stabilized Nitsche contributions to the stiffness matrices
%
% 4. Assemble to the global penalty/coupling-stiffness matrix
%
% 5. Compute the global load vector
%
% 6. Reduce the system according to the constraints
%
...
%
% 10. Compute the complete force vectors at each patch
%
% 11. Appendix
%
%% Function main body
if strcmp(outMsg,'outputEnabled')
    ...
    fprintf('membrane action using the Nitsche-type element-wise stabilized method has been \n');
    fprintf('initiated\n\n');
...
%% 3. Compute the stabilized Nitsche contributions to the stiffness matrices
if strcmp(outMsg,'outputEnabled')
    fprintf('>> Computing the stabilized Nitsche contributions to the stiffness and coupling matrices\n');
end
[KnStabil1,KnStabil2,CnStabil1,CnStabil2] = ...
    computeNitscheMtcesElementwiseStabilIGAPlateInMembraneAction(patch1,K1,patch2,K2,gamma,haveTheSameOrientation,intC);

%% 4. Assemble to the global penalty/coupling-stiffness matrix
if strcmp(outMsg,'outputEnabled')
    fprintf('>> Assembling to the global Nitsche coupling matrix\n');
end
K = [KnStabil1 CnStabil1
     CnStabil2 KnStabil2];
