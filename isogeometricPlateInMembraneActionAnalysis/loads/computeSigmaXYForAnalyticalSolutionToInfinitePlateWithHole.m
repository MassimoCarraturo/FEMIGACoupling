...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function sigmaXY = computeSigmaXYForAnalyticalSolutionToInfinitePlateWithHole(x,y)
%% Function documentation
%
% Returns the analytical stress resultant sigma_xy in the Cartesian space
...
%
%  Output :
% sigmaXY : The magnitude of sigma_xy at (x,y)
%
% Function layout :
%
% 0. Read input
...
sigmaXY = sigmaTheta1*sin(theta)*cos(theta) - sigmaTheta2*sin(theta)*cos(theta) - sigmaTheta1Theta2*((sin(theta))^2-(cos(theta))^2);
