...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function haveTheSameOrientation = findSubdomainInterfaceOrientation(p1,Xi1,q1,Eta1,CP1,isNURBS1,xicoup1,etacoup1,p2,Xi2,q2,Eta2,CP2,isNURBS2,xicoup2,etacoup2)
...
R1 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,isNURBS1,0);
xStart1 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,R1);
...
etaSpan1 = findKnotSpan(eta1,Eta1,neta1);
R1 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,isNURBS1,0);
xMiddle1 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,R1);
...
etaSpan1 = findKnotSpan(eta1,Eta1,neta1);
R1 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,isNURBS1,0);
xEnd1 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan1,p1,xi1,Xi1,etaSpan1,q1,eta1,Eta1,CP1,R1);
...
R2 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,isNURBS2,0);
xStart2 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,R2);
...
etaSpan2 = findKnotSpan(eta2,Eta2,neta2);
R2 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,isNURBS2,0);
xMiddle2 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,R2);
...
etaSpan2 = findKnotSpan(eta2,Eta2,neta2);
R2 = computeIGABasisFunctionsAndDerivativesForSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,isNURBS2,0);
xEnd2 = computeCartesianCoordinatesOfAPointOnBSplineSurface(xiSpan2,p2,xi2,Xi2,etaSpan2,q2,eta2,Eta2,CP2,R2);
