...
function [dHat,FComplete,minElSize] = solve_IGA_FEM_PlateInMembraneActionLinear...
    (Beta,XiB,p,Xi,q,Eta,CP,isNURBS,parameters,Fl,bodyForces,homDOFs,inhomDOFs,...
    valuesInhomDOFs,int,outMsg,...
    strMsh,homDOFsFEM,inhomDOFsFEM,valuesInhomDOFsFEM,...
    NBC,IBC,F,bodyForcesFEM,analysis,parametersFEM,nLinearAnalysisFEM,strDynamics,intFEM,...
...
[dHat,~,~,FComplete,minElSize] = solve_IGA_FEM_LinearSystem(Beta,dHatSaved, ...
    dHatDotSaved,dHatDDotSaved,XiB,BSplinePatch,Fl,bodyForces,parameters,...
    ...
    uSaved, ...
    uDotSaved,uDDotSaved,strMsh,analysis,IBC,F,bodyForcesFEM,parametersFEM,uDot, ...
