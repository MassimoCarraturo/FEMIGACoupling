...
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [x,flag] = computeIntersectionBetweenStraightLines(x1,x2,x3,x4)
...
%    flag : Boolean on whether the two line actually intersect
%
%% Function main body
...
% Form matrix J
J = [x2(1,1)-x1(1,1) x3(1,1)-x4(1,1) ; x2(1,2)-x1(1,2) x3(1,2)-x4(1,2)];

if abs(det(J))>=eps
    % Form right-hand side
    r = [x3(1,1)-x1(1,1) ; x3(1,2)-x1(1,2)];
